...
// ============================================================================
// GUIA DE MIGRAÇÕES OFICIAIS SUPABASE (HOTEL OS)
// ============================================================================
export const SUPABASE_SQL_SCRIPT = `-- ============================================================================
-- HOTEL OS — GUIA OFICIAL DE MIGRAÇÕES VERSIONADAS
-- Todas as migrações estão versionadas e rastreáveis no diretório /supabase-migrations/
-- Execute os arquivos em ordem no SQL Editor do seu projeto Supabase:
--
-- 001_hotel_os_foundation.sql (Organizações, Hotéis, Quarto Camas, Índices)
-- 002_pdv_tablet_reservas.sql até 023_checkout_governanca_event.sql (PDV, KDS, Kanban, Folios)
-- 024_schema_consolidation_audit.sql (Consolidação de tipos TIMESTAMPTZ, integridade referencial)
-- ============================================================================

-- Para inicialização rápida do schema base:
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Consulte o diretório /supabase-migrations/ para o histórico completo e auditável.
`;
