...
import { LayoutDashboard, BedDouble, CalendarDays, LogIn, Users, DollarSign, ShoppingBag, Bot, Palette, UserCheck, ShieldAlert, Lock, ArrowRight, Columns3, Sparkles } from 'lucide-react';
import { AdminTab } from '../../types';
import { getTheme, getFontFamilyClass } from '../../utils/themeHelper';

export const AdminLayout: React.FC = () => {
  const { hotelConfig, adminActiveTab, setAdminActiveTab, currentUser, reservations, rooms, users, hasTabAccess } = useHotel();
  ...
  const navItems: { id: AdminTab; label: string; icon: React.FC<{className?:string}>; badge?: number }[] = [
    ...
    { id:'command_center', label:'Central Hotel OS', icon:Sparkles },
