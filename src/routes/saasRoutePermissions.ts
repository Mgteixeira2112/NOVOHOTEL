...
const ROUTE_PERMISSION_POLICIES: Partial<Record<SaaSRouteId, SaaSRoutePermissionPolicy>> = {
  ...
  'hotel-operations': { backendPermission: PERMISSIONS.housekeepingView },
  'hotel-housekeeping': { backendPermission: PERMISSIONS.housekeepingView },
  'hotel-maintenance': { backendPermission: PERMISSIONS.maintenanceView },
