...
const isFullyWidgetDriven = (definition: WorkspaceDefinition) => definition.widgets
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-slate-100 p-6">
      <div className="max-w-md rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm text-slate-500">Workspace ainda não possui todos os widgets funcionais registrados.</p>
      </div>
    </div>
  );
};
