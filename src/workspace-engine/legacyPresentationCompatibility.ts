...
/**
 * Compatibility-only presentation model for historical persisted Workspace definitions.
 *
 * The active Workspace runtime and Factory must not depend on this module. It exists only
 * to keep old serialized definitions readable while the visual presentation contract is
 * consolidated. Do not use these helpers when creating or editing new Workspaces.
 */
