...
export const GenericOperationalWorkspace: React.FC<{ definition: WorkspaceDefinition }> = ({ definition }) => {
  ...
  const boardId = definition.widgets.find(widget => widget.type === 'task-kanban' || widget.type === 'kanban-cards')?.boardId || 'kanban-default-board';
