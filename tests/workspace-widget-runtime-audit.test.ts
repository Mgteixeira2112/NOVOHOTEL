...
test('todo widget oficial tem maturidade explícita e tipos únicos', () => {
  assert.equal(catalogEntries.length, 28, 'a biblioteca oficial deve manter 28 tipos auditados nesta baseline');
...
test('runtime registra 22 renderers operacionais e quatro adapters administrativos', () => {
